...
<form method="post" action="process.php">
    <div class="row mb-3 mt-3">
        ...
        <div class="col">
            <input name="phone" type="number" class="form-control" placeholder="Enter number" >
        </div>
    </div>
    <div class="row mb-3 mt-3">
        <div class="col">
    ...
    <div class="mb-3">
        <input name="checkbox_listsubject[]" type="checkbox" class="form-control-check" id="html"  value="HTML">
        <label for="html" class="form-label">HTML</label>

        <input name="checkbox_listsubject[]" type="checkbox" class="form-control-check" id="css"  value="CSS">
        <label for="css" class="form-label">CSS</label>

        <input name="checkbox_listsubject[]" type="checkbox" class="form-control-check" id="js"  value="JavaScript">
        <label for="js" class="form-label">Javascript</label>

        <input name="checkbox_listsubject[]" type="checkbox" class="form-control-check" id="php"  value="PHP">
